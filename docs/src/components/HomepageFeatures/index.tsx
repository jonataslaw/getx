...
const FeatureList: FeatureItem[] = [
  ...
  },
  {
    ...
    description: (
      <>
          GetX uses an easy and pleasant syntax.
          No matter what you want to do, there is always an easier way with GetX.
      </>
    ),
  },
  {
  ...
  return (
    <section className={styles.features}>
      <div className="container">
          <div className="row text-center" style={{textAlign: "center", padding: "45px 0"}}>
              <div className="col">
                  <h1>Principles</h1>
              </div>
          </div>
