...
- [State Management](#state-management)
  - [Simple State Manager](#simple-state-manager)
    - [Advantages of using it](#advantages-of-using-it)
    - [Simple state manager usage](#simple-state-manager-usage)
    - [How it handles controllers](#how-it-handles-controllers)
    - [You won't need StatefulWidgts anymore](#you-wont-need-statefulwidgts-anymore)
...
### You won't need StatefulWidgts anymore
