...
- Note²: This step is only necessary if you are going to use route management (`Get.to()`, `Get.back()` and so on). If you are not going to use it then it is not necessary to do step 1
