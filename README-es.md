...
- [Los tres pilares](#los-tres-pilares)
  * [Gestión del Estado](#gesti-n-del-estado)
    + [Reactivo STATE_MANAGER](#reactivo-state-manager)
    + [Más detalles sobre la gestión del estado.](#m-s-detalles-sobre-la-gesti-n-del-estado)
  * [Gestión de Rutas](#gesti-n-de-rutas)
    + [Más detalles sobre la gestión de rutas.](#m-s-detalles-sobre-la-gesti-n-de-rutas)
  * [Gestión de dependencias](#gesti-n-de-dependencias)
    + [Más detalles sobre la gestión de dependencias.](#m-s-detalles-sobre-la-gesti-n-de-dependencias)
- [Utils](#utils)
